...
# -*- coding: utf-8 -*-
"""
Step 4-4: ATPM=0일 때 Flux 상세 분석 및 Export
...
def analyze_carbon_pathway(model, solution):
    ...
    ac_to_accoa_rxns = {
        ...
        'ACACT1r': 'Acetyl-CoA transferase',
    }
...
def export_fluxes(model, solution, output_file):
    ...
    # 주요 반응 카테고리
    categories = {
        'Acetate_Uptake': ['EX_ac_e', 'ACtexi'],
        'Acetyl_CoA_Synthesis': ['ACS_ADP', 'ACS', 'ACACT1r'],
        'TCA_Cycle': ['CS', 'ACONT', 'ICDHx', 'AKGDH', 'SUCDi', 'FUM', 'MDH'],
        'Glyoxylate_Shunt': ['ICL', 'MALS'],
        'Gluconeogenesis': ['PEPCK_ATP', 'PCK', 'PYCK', 'PYK', 'PPC'],
...
def main():
    ...
    print("="*70)
    print("Step 4-4: ATPM=0일 때 Flux 상세 분석")
    print("="*70)
    ...
    # Flux export
    output_file = output_dir / "flux_analysis_atpm0.csv"
