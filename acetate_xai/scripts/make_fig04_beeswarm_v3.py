...
def main(argv: list[str] | None = None) -> int:
    p = argparse.ArgumentParser(description="Fig04 v3: aesthetic SHAP beeswarm (severity regression) with percentile zoom.")
    ...
    p.add_argument("--alpha", type=float, default=0.6, help="Point alpha (default: 0.6)")
    p.add_argument("--s", type=float, default=30, help="Point size (default: 30)")
    ...
    p.add_argument(
        "--out",
        default=str(Path("results") / "figures_draft" / "Fig04_shap_severity_beeswarm_v3.png"),
    ...
    # Robust SHAP via xgboost pred_contribs
    ...
    # Zoom-in xlim to percentile range to avoid outliers compressing the beeswarm
